...
const String _SSID = "Bandit"; //Your wi-fi name
const String _PASSWORD = "MaksiM123"; //Your wi-fi password

// Your Domain name with URL path or IP address with path
//
const String API_KEY = "698bef24744bdcfdc41565e15359931f"; //API KEY for http get request to forecast site

// Replace with your country code and city
//
const String CITY = "Kharkiv"; //Your city for the forecast
